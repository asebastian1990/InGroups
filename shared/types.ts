...
export const FREE_WORD_SETS: WordSet[] = [
  ...
  },
  {
    ...
    isCustom: false,
    words: [
      'Homeroom', 'Homework', 'Textbook', 'Worksheet', 'Quiz', 'Exam', 'Midterm', 'Final Exam', 'Report Card', 'Diploma',
      'Graduation', 'Cap and Gown', 'Locker', 'Hall Pass', 'Recess', 'Bell Schedule', 'Detention', 'Scholarship', 'Tuition', 'Semester',
      'Attendance', 'Tardy', 'Substitute Teacher', 'Elective', 'Algebra', 'Geometry', 'Biology', 'Chemistry', 'Physics', 'World History',
      'English Class', 'Spelling Bee', 'Vocabulary', 'Essay', 'Research Paper', 'Science Fair', 'Field Trip', 'Prom', 'Homecoming', 'Pep Rally',
      'Yearbook', 'Debate Club', 'Marching Band', 'Art Class', 'Gym Class', 'Guidance Counselor', 'Bulletin Board', 'Globe', 'Microscope', 'Lab Coat',
      'Lab Goggles', 'Protractor', 'Crayons', 'Glue Stick', 'Lunch Tray', 'Cafeteria', 'Gymnasium', 'Auditorium', 'Principal', 'Honor Roll',
    ],
  },
  {
    id: 'hospital',
    ...
    isCustom: false,
    words: [
      'Stethoscope', 'Blood Pressure Cuff', 'Thermometer', 'IV Drip', 'Bandage', 'Plaster Cast', 'Crutch', 'Operating Room', 'Emergency Room', 'ICU',
      'Waiting Room', 'Exam Room', 'Patient Room', 'Recovery Room', 'X-Ray', 'MRI', 'CT Scan', 'Ultrasound', 'Lab Results', 'Prescription',
      'Dosage', 'Syringe', 'Vaccine', 'Antibiotic', 'Anesthesia', 'Defibrillator', 'Oxygen Mask', 'Hospital Gown', 'Medical Chart', 'Triage',
      'Admission', 'Discharge', 'Outpatient', 'Inpatient', 'Checkup', 'Physical Exam', 'Blood Draw', 'Biopsy', 'Stitches', 'Suture',
      'Splint', 'Gurney', 'Stretcher', 'Medical Bill', 'Insurance Form', 'Visitor Badge', 'Hand Sanitizer', 'Radiology', 'Pathology', 'Pediatrics',
      'Maternity Ward', 'Blood Transfusion', 'Organ Donor', 'Medical History', 'Symptoms', 'Diagnosis', 'Prognosis', 'Referral', 'Follow-Up Visit', 'Hospital Bracelet',
    ],
  },
  {
    id: 'weather',
    ...
    isCustom: false,
    words: [
      'Thunder', 'Lightning', 'Storm', 'Hurricane', 'Tornado', 'Typhoon', 'Blizzard', 'Hail', 'Sleet', 'Fog',
      'Mist', 'Drizzle', 'Downpour', 'Shower', 'Heat Wave', 'Cold Snap', 'Frost', 'Ice Storm', 'Overcast', 'Partly Cloudy',
      'Clear Skies', 'UV Index', 'Humidity', 'Dew Point', 'Barometer', 'Forecast', 'Meteorologist', 'Weather Vane', 'Rainbow', 'Sunshine',
      'Sunset', 'Sunrise', 'Dusk', 'Dawn', 'Golden Hour', 'Monsoon', 'Cyclone', 'Gale', 'Breeze', 'Gust',
      'Drought', 'Flood', 'Flash Flood', 'Sandstorm', 'Dust Storm', 'Wind Chill', 'Heat Index', 'Air Quality', 'Smog', 'Pollen Count',
      'Winter Storm', 'Weather Watch', 'Weather Warning', 'Radar', 'Satellite Image', 'Climate', 'Temperature', 'Precipitation', 'Atmosphere', 'Jet Stream',
    ],
  },
  {
    id: 'materials',
    ...
    isCustom: false,
    words: [
      'Concrete', 'Stone', 'Glass', 'Brick', 'Clay', 'Ceramic', 'Porcelain', 'Marble', 'Granite', 'Limestone',
      'Sandstone', 'Roofing Slate', 'Asphalt', 'Cement', 'Plaster', 'Drywall', 'Plywood', 'Lumber', 'Timber', 'Bamboo',
      'Cork', 'Plastic', 'Nylon', 'Polyester', 'Acrylic', 'Fiberglass', 'Carbon Fiber', 'Stainless Steel', 'Aluminum', 'Titanium',
      'Brass', 'Zinc', 'Pewter', 'Tin', 'Wool', 'Cotton', 'Silk', 'Leather', 'Suede', 'Felt',
      'Foam', 'Insulation', 'Tile', 'Gravel', 'Sand', 'Soil', 'Mud', 'Tar', 'Resin', 'Epoxy',
      'Adhesive', 'Mortar', 'Rebar', 'Wire Mesh', 'Sheet Metal', 'Plexiglass', 'Polycarbonate', 'Vinyl', 'Linoleum', 'Particle Board',
    ],
  },
  {
    id: 'gemstones',
    ...
    isCustom: false,
    words: [
      'Diamond', 'Amethyst', 'Topaz', 'Opal', 'Pearl', 'Garnet', 'Peridot', 'Citrine', 'Onyx', 'Agate',
      'Jasper', 'Quartz', 'Moonstone', 'Sunstone', 'Lapis Lazuli', 'Malachite', 'Tanzanite', 'Tourmaline', 'Spinel', 'Zircon',
      'Alexandrite', 'Morganite', 'Kunzite', 'Rhodolite', 'Iolite', 'Bloodstone', 'Carnelian', 'Chrysoprase', 'Labradorite', 'Tiger Eye',
      'Aventurine', 'Hematite', 'Cat Eye Gem', 'Star Sapphire', 'Black Diamond', 'Pink Diamond', 'Rough Diamond', 'Faceted Gem', 'Cabochon', 'Birthstone',
      'Carat Weight', 'Gem Clarity', 'Brilliance', 'Facet Cut', 'Gem Inclusion', 'Gem Luster', 'Mohs Hardness', 'Gem Cutter', 'Lapidary', 'Prong Setting',
      'Engagement Stone', 'Crown Jewel', 'Rhinestone', 'Synthetic Diamond', 'Heat-Treated Gem', 'Raw Crystal', 'Gem Mining', 'Gem Polishing', 'Loupe', 'Gemologist',
    ],
  },
  {
    id: 'body-parts',
    ...
    isCustom: false,
    words: [
      'Brain', 'Skull', 'Forehead', 'Eyebrow', 'Eyelash', 'Nostril', 'Upper Lip', 'Lower Lip', 'Chin', 'Cheek',
      'Jawbone', 'Neck', 'Throat', 'Adam\'s Apple', 'Shoulder Blade', 'Armpit', 'Elbow', 'Wrist', 'Knuckle', 'Fingernail',
      'Thumb', 'Torso', 'Rib Cage', 'Spine', 'Backbone', 'Hip Bone', 'Pelvis', 'Thigh', 'Knee Cap', 'Shin',
      'Ankle Bone', 'Heel', 'Big Toe', 'Achilles Tendon', 'Calf Muscle', 'Bicep', 'Tricep', 'Hamstring', 'Quadriceps', 'Muscle Tissue',
      'Tendon', 'Ligament', 'Collarbone', 'Sternum', 'Lung', 'Liver', 'Kidney', 'Small Intestine', 'Large Intestine', 'Bladder',
      'Pancreas', 'Spleen', 'Gallbladder', 'Esophagus', 'Diaphragm', 'Voice Box', 'Earlobe', 'Ear Canal', 'Tonsil', 'Uvula',
    ],
  },
];
